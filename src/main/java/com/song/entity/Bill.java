...
public class Bill extends Entity{
	...
	public Bill(Integer id, Integer billYear, Integer billMonth, Integer buildingId, Integer deviceId, Double waterUsed, Double waterFee, Double energyUsed, Double energyFee, Double totalFee, Integer paid) {
		this.id = id;
