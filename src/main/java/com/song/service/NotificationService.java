...
import com.song.mapper.NotificationMapper;
import com.song.entity.Notification;
...
public class NotificationService {
    ...
    public PageInfo<Notification> queryMyDevice(Integer userId){
        return new PageInfo<Notification>(notificationMapper.queryMyDevice(userId));
    }
